...
describe('Given the user has completed the purchase,', () => {
  this.tags = ['checkoutComplete', 'checkoutCompleteRegression', 'Regression'];
  ...
  it('Verify that the Completed Checkout page has all required elements', async () => {
    await completedCheckoutPage.clickCompletedCheckoutButton(browser, completedCheckoutPage.backToHome);
