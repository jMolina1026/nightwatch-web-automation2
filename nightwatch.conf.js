...
module.exports = {
  ...
  // globals_path : 'nightwatch/helpers/globals.js',

  webdriver: {},
  
  test_workers: { //controls parellel runs
    enabled: true,
    workers: 'auto'
  },
  ...
  test_settings: {
    default: {
      launch_url: process.env.BASE_URL||'https://www.saucedemo.com/',
      test_runner: {
        type: 'default',
      ...
      launch_url: 'https://www.saucedemo.com',//|| 'https://nigthwatchjs.org',
